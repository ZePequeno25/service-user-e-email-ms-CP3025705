...
# Upgrade Plan: user (20260319014428)

- **Generated**: 2026-03-18 <!-- replace with actual date and time when generating -->
...
**JDKs**
- JDK 17: C:\Program Files\Java\jdk-17\bin
...
| Spring Boot | 4.0.3 | 3.5.x | Requires Java 21, incompatible with target Java 17 |

| Maven Wrapper | 3.9.12 | 3.9.12 | - |
...
- Downgrade Spring Boot from 4.0.3 to 3.5.x to ensure compatibility with Java 17.
...
- Step 1: Setup Environment
  - **Rationale**: Verify required JDK and build tools are available.
  - **Changes to Make**:
    - [ ] Confirm JDK 17 is available
    - [ ] Confirm Maven Wrapper is executable
  - **Verification**:
    - Command: Verify paths exist
    - Expected: JDK 17 and Maven wrapper available
...
- Step 2: Setup Baseline
  ...
  - **Verification**:
    - Command: mvnw clean compile test-compile && mvnw clean test
    - JDK: C:\Program Files\Java\jdk-17\bin
    - Expected: Document results (may fail due to Spring Boot 4.0 + Java 17 incompatibility)

- Step 3: Downgrade Spring Boot
  - **Rationale**: Downgrade Spring Boot to 3.5.x for Java 17 compatibility.
  - **Changes to Make**:
    - [ ] Update spring-boot-starter-parent version to 3.5.0
  - **Verification**:
...
- Step 4: Final Validation
  - **Rationale**: Verify compatibility and test success.
  - **Changes to Make**:
