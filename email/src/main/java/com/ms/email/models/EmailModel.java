...
// Importações necessárias para a entidade EmailModel
import com.ms.email.enums.StatusEmail;
import jakarta.persistence.*;
import java.io.Serializable;
import java.time.LocalDateTime;
import java.util.UUID;
// Define a entidade EmailModel, mapeada para a tabela 'TB_EMAILS' no banco de dados
@Entity
@Table(name = "TB_EMAILS")
public class EmailModel implements Serializable {
    private static final long serialVersionUID = 1L;
    // Define o campo 'emailId' como a chave primária da entidade, gerada automaticamente como UUID
    @Id
    ...
    // Define a coluna 'text' como do tipo TEXT no banco de dados para armazenar mensagens longas
